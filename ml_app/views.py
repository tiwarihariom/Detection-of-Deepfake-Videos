...
def get_accurate_model(sequence_length):
    ...
    for i in model_name:
        try:
            ...
            pass  # Ignoring files that don't match the expected naming convention
    ...
    if sequence_model:
        ...
        final_model = None  # Or set a default model name if you have one

    if final_model is None:
        raise ValueError(f"No model found for sequence length: {sequence_length}")
